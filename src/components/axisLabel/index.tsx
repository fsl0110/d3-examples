...
export const AxisLabel: FC<AxisLabelProps> = ({align, letterSpacing, className, children, ...rest}) => {
  const {
  ...
  return (
    <g transform={transform} {...rest}>
      <Text className={classNames("axis-label", className)} textAnchor={textAnchor}>
        {children}
      </Text>
    </g>
  );
